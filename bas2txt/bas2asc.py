...
def usagi():
    ...
    usagi=["Usage:",
        n + "source.bas debas.asc rebas.bas     complete round-trip for testing",
        n + "source.bas debas.asc               convert basic tokenized file into plain text",
        n + "source.asc rebas.bas               tokenize plain text and produce .bas file"]
    print("\n".join(usagi))
